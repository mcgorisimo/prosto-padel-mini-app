-- Read-only precheck for 029_backend_match_notifications.sql.
...
begin
  ...
  if exists (
    ...
    raise exception 'PRECHECK_FAILED: migration 029 target object already exists';
  end if;
...
) as backend_match_notifications_precheck;
